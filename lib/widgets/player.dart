    ...
    if (oldWidget.nowPlaying != widget.nowPlaying) {
      ...
      player.stream.playlist.listen((event) {
        setState(() {
          ...
          nowPlayingAlbum =
              widget.allSongs[player.state.playlist.index]['album'];
        });
      });
    }
  }
              ...
              builder: (context, snapshot) {
                ...
                return Column(
                  children: [
                    ...
                    Text("$nowPlayingArtist - $nowPlayingAlbum", style: const TextStyle(fontSize: 15)),
                        ...
                        Row(
                          children: [
                            ...
                            Slider(
                                ...
                                label:
                                    "${player.state.rate.toStringAsFixed(2)}x",
                                onChanged: (e) {
                                  player.setRate(e);
                                  setState(() {});
                                },
